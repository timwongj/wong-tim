...
function update()
{
	$.get("data/cornerComms.csv", function(data) {
   		...
   		for (i = 1; i < lines.length; i++)
   		{
        	...
        	$("#cornerCommsTableBody").append("<tr><td class=\"centerCol\">" + line[1] + "</td><td class=\"centerCol\">" + line[2] + "</td><td>" + line[3] + "</td><td class=\"centerCol\">" + line[4] + "</td><td>" + line[5] + "</td><td class=\"centerCol\">" + line[6] + "</td></tr>");
		}
	}, "text");
	$.get("data/edgeComms.csv", function(data) {
   		...
   		{
        	var line = lines[i].split(",");
        	$("#edgeCommsTableBody").append("<tr><td class=\"centerCol\">" + line[1] + "</td><td class=\"centerCol\">" + line[2] + "</td><td>" + line[3] + "</td><td class=\"centerCol\">" + line[4] + "</td><td>" + line[5] + "</td><td class=\"centerCol\">" + line[6] + "</td></tr>");
		}
	}, "text");
	$.get("data/OPAlgs.csv", function(data) {
   		...
   		{
        	var line = lines[i].split(",");
        	$("#OPAlgsTableBody").append("<tr><td class=\"centerCol\">" + line[0] + "</td><td>" + line[1] + "</td><td class=\"centerCol\">" + line[2] + "</td><td class=\"centerCol\">" + line[3] + "</td><td>" + line[4] + "</td><td class=\"centerCol\">" + line[5] + "</td><td class=\"centerCol\">" + line[6] + "</td></tr>");
		}
	}, "text");
	$.get("data/M2Algs.csv", function(data) {
   		...
   		{
        	var line = lines[i].split(",");
        	$("#M2AlgsTableBody").append("<tr><td class=\"centerCol\">" + line[0] + "</td><td>" + line[1] + "</td><td class=\"centerCol\">" + line[2] + "</td><td class=\"centerCol\">" + line[3] + "</td><td>" + line[4] + "</td><td class=\"centerCol\">" + line[5] + "</td><td class=\"centerCol\">" + line[6] + "</td></tr>");
		}
	}, "text");
